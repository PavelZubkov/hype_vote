...
;
	($.$hype_vote_app) = class $hype_vote_app extends ($.$mol_book2) {
		yard(){
		...
		Poll_link(id){
			const obj = new this.$.$mol_link();
			(obj.arg) = () => ({"poll": (this.poll_id(id))});
			(obj.sub) = () => ([(this.poll_name(id))]);
			return obj;
		}
		poll_list(){
			return [(this.Poll_link("0"))];
		}
		Poll_list(){
			const obj = new this.$.$mol_list();
		...
		Polls_body(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ([(this.Poll_add()), (this.Poll_list())]);
			return obj;
		}
		Online(){
		...
		Polls_page(){
			...
			(obj.title) = () => ("$hype_vote");
			(obj.body) = () => ([(this.Polls_body())]);
			(obj.foot) = () => ([(this.Online()), (this.Source())]);
			return obj;
		}
		poll_opened_id(){
			return "";
		...
		Point_add(){
			const obj = new this.$.$mol_button_minor();
			(obj.sub) = () => ([(this.Point_add_icon()), (this.Point_add_label())]);
		...
		Point_drop(id){
			const obj = new this.$.$mol_button_minor();
			(obj.sub) = () => ([(this.Point_drop_icon(id))]);
		...
		voting_points(){
			return [(this.Voting_point("0"))];
		}
		Voting_page(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ((this.poll_voting_name()));
			(obj.tools) = () => ([(this.Home()), (this.Source())]);
			(obj.body) = () => ((this.voting_points()));
			return obj;
		}
	};
	($mol_mem(($.$hype_vote_app.prototype), "yard"));
	($mol_mem(($.$hype_vote_app.prototype), "poll_add"));
	($mol_mem(($.$hype_vote_app.prototype), "Poll_add"));
	($mol_mem_key(($.$hype_vote_app.prototype), "Poll_link"));
	($mol_mem(($.$hype_vote_app.prototype), "Poll_list"));
	($mol_mem(($.$hype_vote_app.prototype), "Polls_body"));
	($mol_mem(($.$hype_vote_app.prototype), "Online"));
	($mol_mem(($.$hype_vote_app.prototype), "Source"));
	($mol_mem(($.$hype_vote_app.prototype), "Polls_page"));
	($mol_mem(($.$hype_vote_app.prototype), "Poll_voting_link"));
	($mol_mem(($.$hype_vote_app.prototype), "poll_opened_name"));
	($mol_mem(($.$hype_vote_app.prototype), "Poll_name_control"));
	($mol_mem(($.$hype_vote_app.prototype), "Poll_name_label"));
	($mol_mem(($.$hype_vote_app.prototype), "Point_add_icon"));
	($mol_mem(($.$hype_vote_app.prototype), "point_add"));
	($mol_mem(($.$hype_vote_app.prototype), "Point_add"));
	($mol_mem(($.$hype_vote_app.prototype), "Points_list_label"));
	($mol_mem_key(($.$hype_vote_app.prototype), "point_name"));
	($mol_mem_key(($.$hype_vote_app.prototype), "Point_name_cotrol"));
	($mol_mem_key(($.$hype_vote_app.prototype), "Point_name_label"));
	($mol_mem_key(($.$hype_vote_app.prototype), "point_image"));
	($mol_mem_key(($.$hype_vote_app.prototype), "Point_image_control"));
	($mol_mem_key(($.$hype_vote_app.prototype), "Point_image_label"));
	($mol_mem_key(($.$hype_vote_app.prototype), "Point_image_preview"));
	($mol_mem_key(($.$hype_vote_app.prototype), "Point_image_preview_label"));
	($mol_mem_key(($.$hype_vote_app.prototype), "Point_drop_icon"));
	($mol_mem_key(($.$hype_vote_app.prototype), "point_drop"));
	($mol_mem_key(($.$hype_vote_app.prototype), "Point_drop"));
	($mol_mem_key(($.$hype_vote_app.prototype), "Point_actions_label"));
	($mol_mem_key(($.$hype_vote_app.prototype), "Point_card"));
	($mol_mem(($.$hype_vote_app.prototype), "Point_rows"));
	($mol_mem(($.$hype_vote_app.prototype), "Poll_body"));
	($mol_mem(($.$hype_vote_app.prototype), "Poll_page"));
	($mol_mem(($.$hype_vote_app.prototype), "Home"));
	($mol_mem_key(($.$hype_vote_app.prototype), "voted"));
	($mol_mem_key(($.$hype_vote_app.prototype), "Voting_point_image"));
	($mol_mem_key(($.$hype_vote_app.prototype), "Voting_point_name"));
	($mol_mem_key(($.$hype_vote_app.prototype), "Votin_point_count"));
	($mol_mem_key(($.$hype_vote_app.prototype), "Voting_point"));
	($mol_mem(($.$hype_vote_app.prototype), "Voting_page"));
